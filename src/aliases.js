const entries = [
  ...
  ['KLARE KANTE', 'SAG'],
  ['MIA SAN AUSGABE', 'SAG'],
  ['FOODBLOGGER URTEIL', 'SAG'],
  ['JETZT KOMMT DER GESCHMACKSTEST', 'SAG'],
  ['AB IN DIE STORY', 'SAG'],
  ['KAMERA LAEUFT', 'SAG'],
  ['JETZT EIN REEL', 'SAG'],
  ['SELFIE MIT ANSAGE', 'SAG'],
  ['PACK MAS', 'SETZE'],
  ['JETZT WIRD GELIEFERT', 'SETZE'],
  ['BAYERN MACHT DAS', 'SETZE'],
  ['ORDNUNG MUSS SEIN', 'SETZE'],
  ['MACHEN STATT REDEN', 'SETZE'],
  ['LINK IN DER BIO', 'SETZE'],
  ['CONTENT PLAN STEHT', 'SETZE'],
  ['GRILL IST AN', 'SETZE'],
  ['TELLER WIRD ANGERICHTET', 'SETZE'],
  ['MEHR DAVON', 'ADDIERE'],
  ['NOCH EINE SCHIPPE', 'ADDIERE'],
  ['BAYERN BONUS', 'ADDIERE'],
  ['DOPPELT HILFT', 'ADDIERE'],
  ['AUFWAERTS IMMER', 'ADDIERE'],
  ['MEHR FLEISCH', 'ADDIERE'],
  ['SCHWEINEBRATEN BONUS', 'ADDIERE'],
  ['FOLLOWER BONUS', 'ADDIERE'],
  ['NOCH EINE BRATWURST', 'ADDIERE'],
  ...
  ['WENIGER GRUEN', 'SUBTRAHIERE'],
  ['DIE GRUENEN WIEDER', 'SUBTRAHIERE'],
  ['GRUENEN CHECK NICHT BESTANDEN', 'SUBTRAHIERE'],
  ...
  ['DOPPELTE BRATWURST', 'MULTIPLIZIERE'],
  ['LIKES MAL LIKES', 'MULTIPLIZIERE'],
  ['CONTENT OFFENSIVE', 'MULTIPLIZIERE'],
